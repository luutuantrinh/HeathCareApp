...
public class UpdateData {
    ...
    public void deleteAllCommentLikeOfPost(String post_id) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (comment.getId_post().equals(post_id)) {
                        commentRef.child(comment.getId_comment()).removeValue();
        ...
        likeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (like.getId_post().equals(post_id)) {
                        commentRef.child(like.getId_like()).removeValue();
                    }
                }
            }
