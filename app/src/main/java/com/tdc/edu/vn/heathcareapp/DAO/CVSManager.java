...
import com.tdc.edu.vn.heathcareapp.DAO.bodymeasures.BodyMeasure;
...
import com.tdc.edu.vn.heathcareapp.DAO.cardio.DAOOldCardio;
import com.tdc.edu.vn.heathcareapp.utils.DateConverter;
...
public class CVSManager {
    ...
    public boolean exportDatabase(Profile pProfile) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            //We use the heathcareapp directory for saving our .csv file.
            File exportDir = Environment.getExternalStoragePublicDirectory("/heathcareapp/export/" + dateFormat.format(date) + pProfile.getName());
            if (!exportDir.exists()) {
                exportDir.mkdirs();
            }
